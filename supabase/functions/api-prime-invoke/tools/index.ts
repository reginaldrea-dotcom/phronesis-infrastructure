...
import { readConferencesTool, readConferenceResponsesTool, postConferenceResponseTool } from "./conference.ts";
...
const TOOLS: Tool[] = [
  ...
  readConferencesTool,
  readConferenceResponsesTool,
  postConferenceResponseTool,
  readWakeDeltasTool,
  readInboxTool,
  getMessageTool,
